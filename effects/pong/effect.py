...
def run(matrix, config):
    ...
    while True:
        ...
        # Draw paddles
        matrix.rectangle((2, left_paddle_y), (3, left_paddle_y + paddle_height), (255, 255, 255), 1)
        matrix.rectangle((x_max, right_paddle_y), (x_max + 1, right_paddle_y + paddle_height), (255, 255, 255), 1)
